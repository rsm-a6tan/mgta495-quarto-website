...
Before taking that number at face value, two things are worth keeping in mind. First, this is an **observational study** — firms weren't randomly assigned to Blueprinty. Unobserved differences such as R&D budget or internal patent counsel could still be driving the result. Second, the Poisson model assumes mean equals variance; if patent counts are overdispersed, a Negative Binomial model would be more appropriate. With those caveats in mind, the evidence here is consistent with Blueprinty's marketing claim — but a randomized trial would be needed to establish true causality.
